...
FEMALE = ["小红", "1997-03-15", "女", "男", "上海", "同城", "认真长期", "25-38",
          "设计师,猫奴", "在做UI设计", "撸猫、爬山、摄影", "去山里露营",
          "真诚", "跳过", "跳过", "拍到了很美的日落", "细心、独立、有趣",
          "一起去看世界吧", "wechat: xiaohong", "xiaohong@example.com"]

FEMALE_FAR = ["阿花", "1996-05-05", "女", "男", "新加坡", "异地也行", "先聊聊看", "25-40",
              "产品经理", "web3产品", "健身、看书", "健身房泡一天",
              "上进", "跳过", "跳过", "升职了", "自律、直接、爽快",
