...
ANSWERS = [
    "小明", "1995-08-20", "男", "女", "上海", "同城", "认真长期", "25-35",
    "程序员一枚,爱笑", "在做 web3 开发", "爬山、撸猫、看电影", "睡到自然醒然后去山里",
    "真诚", "跳过", "2021年牛市进的圈,BTC本位", "捡到一只小猫", "靠谱、幽默、温柔",
    "希望我们都能做真实的自己", "tg: @xiaoming", "xiaoming@example.com",
]
